  ...
  return <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        duration: 0.6
          ...
          <div className="inline-block mb-4 px-4 py-2 bg-gradient-to-r from-blue-500/10 to-teal-500/10 rounded-full border border-blue-200/50">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">
            Success <span className="bg-gradient-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent">Stories</span>
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Don't just take our word for it. Hear from our graduates who have successfully launched their careers
          </p>
        </motion.div>
