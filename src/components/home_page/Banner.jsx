        ...
        <Contaoner>
          <div className="flex gap-20  ">
            ...
            <div className="w-1/2">
              ...
              <h1 className='text-[72px] font-nunito font-bold transition-colors  bg-linear-to-r from-primary to-tertiary bg-clip-text text-transparent drop-shadow-lg'>Nextzen Academy</h1>
              <h3 className='text-[32px] font-inter font-medium text-tertiary '>Solar & Electrical SystemInstallation and Maintenance</h3>
              <p className='text-[18px] text-[tertiary] font-inter font-normal mt-7'>Transform your future with hands-on practical training in solar and electrical systems. Work on real projects, learn from expert instructors, and unlock career opportunities in the booming renewable energy industry.</p>
              <div className="">
              ...
              <div className=" flex items-center gap-15 mt-10">
                <div className="">
                  <h3 className='text-[36px] text-primary font-bold font-inter'>500+ </h3>
                  <h4 className='text-[16px] text-black font-inter font-normal'>Students Trained</h4>
                </div>
                <div className="">
                  <h3 className='text-[36px] text-tertiary font-bold font-inter'>150+ </h3>
                  <h4 className='text-[16px] text-black font-inter font-normal'>Projucts</h4>
                </div>
                <div className="">
                  <h3 className='text-[36px] text-primary font-bold font-inter'>98% </h3>
